...
public class EffExpandContract extends SkWEEffect {
    ...
    protected void execute(Event event) {
        if (vert) {
            ...
            Direction direction = getDirection(this.direction);
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "expand " + wrappers.toString(event, debug) + " by " + (distance != null ? distance.toString(event, debug) : "1") + " and " + (reverseDistance != null ? reverseDistance.toString(event, debug) : "0");
    }
